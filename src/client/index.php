	...
	<section>
		...
		<article id='home'>
			...
			<p class="container" id="description">
				...
				Die Fahrräder sind allesamt mit einem GPS-Sender ausgestattet, der es ermöglicht diese zu lokalisieren.
				Aus Datenschutzgründen wird das GPS-Gerät während der Mietdauer ausgeschaltet.
			</p>
		</article>
	</section>
